...
public class ObstacleFading_Physics_OvelapSphere_Custom : MonoBehaviour
{
    ...
    private IEnumerator checkPlayerCoroutine()
    {
        while (true)
        {
            Collider[] colliders = Physics.OverlapSphere(transform.position + spawnPosition, radius, playerLayer);
